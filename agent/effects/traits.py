...
class TraitBuilder:
    ...
    def attacker_disadvantage(source_id: str, name: str = "", description: str = "") -> ModifierTrait:
        return ModifierTrait(
            source_id=source_id,
            feature_id="attacker_disadvantage",
            name=name,
    ...
    def target_disadvantage(source_id: str, name: str = "", description: str = "") -> ModifierTrait:
        return ModifierTrait(
            source_id=source_id,
            feature_id="target_disadvantage",
            name=name,
    ...
    def disadvantage_on_save(
        ...
        return ModifierTrait(
            source_id=source_id,
            feature_id=f"save_disadvantage_{ability.value}",
            name=name,
    ...
    def advantage_on_save(source_id: str, ability: AbilityType, name: str = "", description: str = "") -> ModifierTrait:
        return ModifierTrait(
            source_id=source_id,
            feature_id=f"save_advantage_{ability.value}",
            name=name,
    ...
    def autofail_save(source_id: str, ability: AbilityType, name: str = "", description: str = "") -> ModifierTrait:
        return ModifierTrait(
            source_id=source_id,
            feature_id=f"save_autofail_{ability.value}",
            name=name,
    ...
    def resistance(
        ...
        return ModifierTrait(
            source_id=source_id,
            feature_id=f"resistance_{damage_type.value}",
            name=name,
    ...
    def vulnerability(
        ...
        return ModifierTrait(
            source_id=source_id,
            feature_id=f"vulnerability_{damage_type.value}",
            name=name,
    ...
    def stealth_disadvantage(source_id: str, name: str = "", description: str = "") -> ModifierTrait:
        return ModifierTrait(
            source_id=source_id,
            feature_id="stealth_disadvantage",
            name=name,
    ...
    def expertise(
        ...
        return ModifierTrait(
            source_id=source_id,
            feature_id=f"expertise_{proficiency.value}",
            name=name,
    ...
    def reflect_melee_damage(
        ...
        return Trait(
            source_id=source_id,
            feature_id="reflect_melee_damage",
            name=name or "Damage Reflection",
            description=description or f"Reflect {int(ratio * 100)}% of melee damage as {damage_type.value}.",
    ...
    def damage_bonus(
        ...
        return Trait(
            source_id=source_id,
            feature_id=f"damage_bonus_{damage_type.value}",
            name=name,
    ...
    def damage_multiplier(
        ...
        return Trait(
            source_id=source_id,
            feature_id=f"damage_multiplier_{damage_type.value}",
    ...
    def ignore_resistance(
        ...
        return Trait(
            source_id=source_id,
            feature_id=f"ignore_resistance_{damage_type.value}",
    ...
    def damage_over_time(
        ...
        return Trait(
            source_id=source_id,
            feature_id=f"dot_{damage_type.value}",
